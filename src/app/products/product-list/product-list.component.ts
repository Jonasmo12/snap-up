...
export class ProductListComponent implements OnInit {
  ...
  clickedCategoryProducts$!: Observable<Product[]>;

  selectedCategory?: CategoryNavComponent

  ngOnInit(): void {
    this.clickedCategoryProducts$ = this.apiService.getProducts();
  ...
  isSelected(category: any): void {
    ...
    this.clickedCategoryProducts$ = this.apiService.getCategory(category).pipe(
